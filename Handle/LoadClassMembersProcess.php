        ...
        <div class="form-group mt-3">
            ...
            <?php if ($AccountType == 0 || $AccountType == 1) { ?>
                <div class="dropdown-tdoc dropdown dropdown-menu-right float-right mt-3">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-info text-left active-none" aria-labelledby="navbarDropdownMenuLink-4">
                        <a class="dropdown-item" data-toggle="modal" data-target="#DeleteStudent<?php echo $id ?>" >Remove</a>
                    </div>
                </div>
            <?php } ?>
        </div>
