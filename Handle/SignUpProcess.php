<?php
    ...
    && !empty($_POST["txtConfirmPassword"])) {
        ...
        if($resultEmail->num_rows > 0) {
            ...
            header("Location: ../View/SignUp?msg=SignUp");
        }
        $connection->close();
    }
