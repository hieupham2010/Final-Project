<div class="modal fade" id="DeleteStudent<?php echo $id ?>" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLongTitle">Remove Student</h5>
            ...
            <div class="modal-body">
                <p>Are you sure remove this student?</p>
                <form action="../Handle/DeleteStudentProcess" method="POST">
